...
export const globalState = { errorMessage: "", userId: "", userName: "", token:"" };
...
function LogIn() {
	...
	return (
		<>
			{isLogged ? <Student user={{ userId:globalState.userId, userName:globalState.userName }} />
				:    isMentor ? <Mentor user={{ userId:globalState.userId, userName:globalState.userName }}/>
